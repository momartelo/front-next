...
export default function CACChart({ data, indice, selectedPeriod }) {
  ...
  const renderDot = (props) => {
    ...
    return <circle cx={cx} cy={cy} r={1} fill="#999" />;
  };
      ...
      <ResponsiveContainer width="100%" aspect={2.5}>
        <LineChart data={formattedData}>
          ...
          <Line
            ...
            name="General"
            stroke="#1d4ed8"
            strokeWidth={indice === "general" ? 3 : 1}
            opacity={indice === "general" ? 1 : 0.3}
            dot={renderDot}
          />
          ...
          <Line
            ...
            name="Materiales"
            stroke="#16a34a"
            strokeWidth={indice === "materials" ? 3 : 1}
            opacity={indice === "materials" ? 1 : 0.3}
            dot={renderDot}
          />
          ...
          <Line
            ...
            name="Mano de obra"
            stroke="#dc2626"
            strokeWidth={indice === "labour_force" ? 3 : 1}
            opacity={indice === "labour_force" ? 1 : 0.3}
            dot={renderDot}
          />
        </LineChart>
      </ResponsiveContainer>
